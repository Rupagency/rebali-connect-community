...
export const LOCATION_GROUPS = {
  bali: [
    "canggu", "pererenan", "berawa", "umalas", "buduk",
    "ubud", "tegallalang", "payangan", "tampaksiring", "pejeng", "mas",
    "seminyak", "legian", "batubelig", "kerobokan",
    "kuta", "tuban",
    "uluwatu", "pecatu", "ungasan", "bingin", "dreamland",
    "denpasar", "sanur", "renon", "tohpati",
    "nusa_dua", "benoa", "tanjung_benoa",
    "jimbaran",
    "nusa_penida", "nusa_lembongan", "nusa_ceningan",
    "gianyar", "sukawati", "batubulan", "celuk", "blahbatuh", "keramas", "ketewel", "saba",
    "klungkung", "kusamba",
    "karangasem", "amed", "candidasa", "padangbai", "tirta_gangga", "jasri", "kubu", "selat", "rendang", "manggis",
    "bangli", "kintamani",
    "tabanan", "tanah_lot", "mengwi", "jatiluwih", "kediri_tabanan", "penebel",
    "singaraja", "lovina", "kalibukbuk", "seririt", "tejakula", "les", "bondalem",
    "negara", "gilimanuk", "melaya", "pekutatan",
    "medewi", "balian",
    "munduk", "bedugul", "wanagiri",
    "sidemen",
    "pemuteran", "tulamben",
    "abiansemal", "sangeh",
  ],
  lombok: [
    ...
    "senggigi", "mangsit", "malimbu",
    "kuta_lombok", "selong_belanak", "tanjung_aan", "gerupuk", "mawi", "ekas",
    "gili_trawangan", "gili_air", "gili_meno",
    "tetebatu", "sembalun", "senaru",
    "bangsal", "pemenang", "tanjung_lombok", "sire",
    "praya", "selong",
    "lembar", "sekotong",
    "labuan_lombok",
    "mandalika",
  ...
  java: [
    ...
    "bogor", "cirebon", "magelang", "kediri", "jember", "pasuruan",
  ],
  other: ["other"],
} as const;
