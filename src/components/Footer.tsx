        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          ...
          <div>
            ...
            <div className="flex flex-col gap-2 text-sm text-muted-foreground">
              ...
              <Link to="/trust-badges" className="hover:text-foreground transition-colors">{t('footer.trustBadgesPoints')}</Link>
            </div>
          </div>
          <div>
          ...
          <div>
            ...
            <div className="flex flex-col gap-2 text-sm text-muted-foreground">
              ...
              <Link to="/pdpl" className="hover:text-foreground transition-colors">{t('footer.pdpl')}</Link>
